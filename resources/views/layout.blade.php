...
<head>
	...
	<link rel="canonical" href="http://localhost/webbanhang/trang-chu"/>
    <!--[if lt IE 9]>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<?php }elseif ($customer_id !=NULL && $customer_id !=NULL) {?>
								...
								<li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
								     ...
								     ?>
								<li><a href="{{URL::to('/show-cart')}}"><i class="fa fa-shopping-cart"></i> Giỏ hàng</li>
									<?php
									$customer_id=Session::get('customer_id');
									if($customer_id!=Null){
									?>
					...
					<div class="col-sm-4">
						<form action="{{URL::to('/tim-kiem')}}" method="post">
							...
							<div class="search_box pull-right">
								...
								<input type="submit" name="search-items" class="btn btn-info btn-sm" value="search">
							</div>
						</form>
					</div>
				</div>
