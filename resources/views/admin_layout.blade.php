    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a onclick="return confirm('Bạn có chắc muốn đăng xuất không')" href="{{URL::to('/logout')}}"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
...
<script src="{{asset('public/backend/js/jquery.formvalidation.js')}}"></script>
<script>
    $.validate({
