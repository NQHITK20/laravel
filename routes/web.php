...
//Check-out
Route::get('/login-checkout', 'App\Http\Controllers\CheckoutController@login2_checkout');
Route::get('/logout-checkout', 'App\Http\Controllers\CheckoutController@logout_checkout');
Route::post('/login-add-checkout', 'App\Http\Controllers\CheckoutController@login_add_checkout');
Route::post('/login-customer', 'App\Http\Controllers\CheckoutController@login_customer');
Route::post('/order-place', 'App\Http\Controllers\CheckoutController@order_place');
Route::get('/check-out', 'App\Http\Controllers\CheckoutController@check_out');
Route::post('/save-check-out-customer', 'App\Http\Controllers\CheckoutController@save_check_out_customer');
